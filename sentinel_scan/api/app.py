...
async def start_scan(request: ScanRequest, background_tasks: BackgroundTasks):
    ...
    background_tasks.add_task(run_scan_task, scan_id, request.targets, request.concurrency)
...
async def run_scan_task(scan_id: str, targets: List[str], concurrency: int):
